  ...
  return (
    <div className="min-h-screen bg-page">
      <nav className="fixed left-0 top-0 h-screen w-16 bg-[#060c12] border-r border-[rgba(var(--green-rgb),0.1)] flex flex-col items-center py-6 gap-4 z-50">
        <Link href="/admin" className="p-2.5 rounded-lg text-[#8b949e] hover:text-accent hover:bg-[rgba(var(--green-rgb),0.05)] transition-colors" title="Dashboard">
          <LayoutDashboard size={20} />
        </Link>
        <Link href="/admin/blog" className="p-2.5 rounded-lg text-[#8b949e] hover:text-accent hover:bg-[rgba(var(--green-rgb),0.05)] transition-colors" title="Blog">
          <FileText size={20} />
        </Link>
